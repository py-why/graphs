...
- [ ] I have read the relevant section in the [contribution guide](https://github.com/pywhy/graphs/blob/main/CONTRIBUTING.md#bug-reports-and-feature-requests) on reporting bugs.
- [ ] I have checked the [issues list](https://github.com/pywhy/graphs/issues) for similar or identical bug reports.
- [ ] I have checked the [pull requests list](https://github.com/pywhy/graphs/pulls) for existing proposed fixes.
